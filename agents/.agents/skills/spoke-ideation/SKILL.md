---
name: spoke-ideation
description: Explore problem spaces, frame projects, and evaluate tradeoffs by rotating ideas through multiple perspectives. Use when thinking needs structure before committing to a direction.
---
