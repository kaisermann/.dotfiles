...
**Changes:** Named the actor ("we"). Replaced false agency with specific claims and a number.
...
**Changes:** Removed rhetorical setup and self-posed questions. Replaced them with a specific failure scenario.
...
**Changes:** Replaced narrator distance with "you." Replaced vague declaratives with the specific structural problem.
...
**Changes:** Replaced false vulnerability with a specific, honest admission. Cut the meta-commentary. Stated the point instead of announcing it.
...
**Changes:** Cut the filler transition and the invented concept label. Replaced the superficial participle analysis with the specific mechanism.
...
**Changes:** Removed the "imagine" opener, the cooking analogy, and the pedagogical "let's unpack." Replaced them with a specific claim, a number, and the mechanism that makes agendas work.
